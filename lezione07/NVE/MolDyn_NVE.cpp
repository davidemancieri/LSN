...
//  AveEpot << iblk << "   " << setprecision(8) << glob_av[iv]/double(iblk) << "   " << Error(glob_av[iv], glob_av2[iv], iblk) << endl;
//  AveEkin << iblk << "   " << setprecision(8) << glob_av[ik]/double(iblk) << "   " << Error(glob_av[ik], glob_av2[ik], iblk) << endl;
//  AveEtot << iblk << "   " << setprecision(8) << glob_av[ie]/double(iblk) << "   " << Error(glob_av[ie], glob_av2[ie], iblk) << endl;
//  AveTemp << iblk << "   " << setprecision(8) << glob_av[it]/double(iblk) << "   " << Error(glob_av[it], glob_av2[it], iblk) << endl;
